def dirReduc(arr):
    ...
    for i in range(len(arr)):
        active.append(True)
        #check if there was already active move in another direction
        ...
        for j in range(i-1,-1,-1):
            if active[j]==True:
                if arr[i]=="NORTH" and arr[j]=="SOUTH":
                    ...
                    active[i]=False
                    break
                elif arr[i]=="SOUTH" and arr[j]=="NORTH":
                    active[j]=False
                    active[i]=False
                    break
                elif arr[i]=="EAST" and arr[j]=="WEST":
                    active[j]=False
                    active[i]=False
                    break
                elif arr[i]=="WEST" and arr[j]=="EAST":
                    active[j]=False
                    active[i]=False
                    break
    result = []
